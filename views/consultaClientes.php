...
<div class ='centralizado'>
    ...
    <form class ='centralizado' id="consultaPessoa" name="consultaPessoa" action="../controladores/controladorIndex.php" method="post">
        ...
        <input class ='botaoAzul' type="submit" id="consultarCliente" name="consultarCliente" value="Consultar">
    </form>
